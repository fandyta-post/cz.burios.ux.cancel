...
public class Utils {
	...
	private static final java.io.File DATA_STORE_DIR = new java.io.File("e:/DATA/repo/burios", "/cancel/calendar");
	...
	private static final String CREDENTIALS_FILE_PATH = "/client_secret_buriosca-cancel.json";
	...
	public static Credential authorize(List<String> scopes) throws Exception {
		...
		GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
				new InputStreamReader(SyncTokenSample.class.getResourceAsStream(CREDENTIALS_FILE_PATH)));
	...
	public static Event createTestEvent(Calendar client, String summary) throws IOException {
		...
		Event event = new Event().setSummary(summary).setReminders(new Reminders().setUseDefault(false))
				.setStart(new EventDateTime().setDateTime(start)).setEnd(new EventDateTime().setDateTime(end));
	 ...
	 *
	 * @param field  the field identifier from {@link java.util.Calendar} to
	 *               increment
