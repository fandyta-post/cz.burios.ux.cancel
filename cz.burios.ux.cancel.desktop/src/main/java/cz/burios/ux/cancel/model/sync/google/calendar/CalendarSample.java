...
public class CalendarSample {
	...
	private static final java.io.File DATA_STORE_DIR = new java.io.File("e:/DATA/repo/burios", "/cancel/credentials");
	...
	private static Credential authorize() throws Exception {
		...
		GoogleAuthorizationCodeFlow flow = 
			new GoogleAuthorizationCodeFlow.Builder(httpTransport, JSON_FACTORY, clientSecrets, Collections.singleton(CalendarScopes.CALENDAR)).setDataStoreFactory(dataStoreFactory).build();
